...
export const authRateLimitMiddleware = {
  ...
  dataImport: create({ windowMs: 60 * 60 * 1000, max: 10, message: 'Too many data import requests. Try again later.' }),
  invitationMutation: create({ windowMs: 15 * 60 * 1000, max: 30, message: 'Too many invitation actions. Try again later.' }),
