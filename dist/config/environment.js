...
var env = {
  ...
  GITHUB_CLIENT_ID_LOCAL: process.env.GITHUB_CLIENT_ID_LOCAL,
  GITHUB_CLIENT_SECRET_LOCAL: process.env.GITHUB_CLIENT_SECRET_LOCAL,
  GITHUB_CLIENT_ID_PRODUCTION: process.env.GITHUB_CLIENT_ID_PRODUCTION,
  GITHUB_CLIENT_SECRET_PRODUCTION: process.env.GITHUB_CLIENT_SECRET_PRODUCTION
};
exports.env = env;